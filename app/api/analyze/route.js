...
1. REQUIRED ELEMENTS — look carefully for each. Mark PRESENT if visible anywhere in the photo, MISSING only if truly absent:
   ...
   - Goodie bag: any InstaHelp branded distribution materials placed at the stall — this includes gift bags, pouches, packets, pamphlets, leaflets, cards, or any branded items placed on or around the promo table for visitors to take. Look carefully on top of and around the promo table. If ANY branded materials/items are visible for distribution, mark goodie bag as PRESENT.
