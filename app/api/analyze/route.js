...
1. REQUIRED ELEMENTS — look carefully for each. Mark PRESENT if visible anywhere in the photo, MISSING only if truly absent:
   ...
   - Promo table: a solid self-standing box/cube/barrel unit that is part of the setup. KEY VISUAL: it has NO visible legs underneath — it sits directly on the ground as a solid block. Color varies: white, blue, purple, or cream. It may or may not have clearly visible InstaHelp text depending on angle. Items like goodie bags are often placed ON TOP of it. If you see a solid box-shaped unit (no legs) anywhere in the setup, that IS the promo table — even if branding is not visible from that angle.
